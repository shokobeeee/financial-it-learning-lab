...
const SUPPLEMENTS={
  ...
  2:[
    {kind:'Zenn / Supplementary',publisher:'Zenn / chooser',title:'GitHub Actionsのコストを見て、自宅にCI・セキュリティ基盤を建てた',date:'2026-08',url:'https://zenn.dev/chooser/articles/series-003-tooling',why:'実機のsplit-brainとfencingを題材に、failoverと「旧主系を締め出す」ことの違いを掴む。'},
    {kind:'Zenn / Concept',publisher:'Zenn / kackey',title:'Storage Replication',date:'n.d.',url:'https://zenn.dev/kackey/articles/storage-replication',why:'非同期replication・Leader failover・split-brain・未反映writeの基本概念を整理する。'}
  ],
  3:[
    ...
    {kind:'Zenn / Hands-on',publisher:'Zenn / supino0017',title:'Azure SQL Databaseのリストア',date:'n.d.',url:'https://zenn.dev/supino0017/articles/905f23553fd0b5',why:'Point-in-Time Restoreを具体操作で確認し、Backup保有とrestore可能性を分けて理解する。'}
  ],
  4:[
  ...
  5:[
    {kind:'Zenn / Architecture',publisher:'Zenn / kg_filled',title:'Cloudflare障害から学ぶフロントエンド耐障害設計4パターン',date:'2026-02-27',url:'https://zenn.dev/kg_filled/articles/925cb0467f0512',why:'別事故の解説を使い、Control Plane変更が広域Edgeへ波及するblast radiusとfallback設計を考える。'}
  ],
  6:[
    ...
    {kind:'Technical / Architecture',publisher:'AWS Architecture Blog',title:'re:Invent 2019: Introducing the Amazon Builders’ Library (Part I)',date:'2019',url:'https://aws.amazon.com/blogs/architecture/reinvent-2019-introducing-the-amazon-builders-library-part-i/',why:'Timeout / retry / backoff / queue backlogが小さな障害を全体障害へ増幅する設計論を補う。'}
  ],
  8:[
  ...
  10:[
    {kind:'Technical / Distributed Systems',publisher:'Amazon Builders’ Library',title:'Making retries safe with idempotent APIs',date:'2021',url:'https://builder.aws.com/content/3Ev0BENTyBr0XxzRk5FDZzgNYos/making-retries-safe-with-idempotent-apis',why:'timeout後の再送で副作用を重複させないためのidempotency設計を、実システム設計の観点で補う。'},
    {kind:'Zenn / Concept',publisher:'Zenn / yoshiyoshifujii',title:'SAGAパターンの補償アクション失敗にどう立ち向かうか？DLQとリトライ戦略',date:'n.d.',url:'https://zenn.dev/yoshiyoshifujii/articles/6028590863dbfb',why:'DLQ・補償処理・retryを通じて、分散取引で「再送すれば良い」では済まない理由を補う。'}
  ]
};
