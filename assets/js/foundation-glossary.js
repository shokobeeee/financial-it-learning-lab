...
const TERMS=[
  ...
  {id:'cloud-resource',label:'Cloud Resource',aliases:['Cloud Resource','クラウドリソース','Resource','リソース'],plain:'Cloud事業者側に作るIT部品',summary:'VM・Network・Database・Storage等をProviderの設備上に払い出したものです。',where:'Console・API・CLI・IaCから作成・設定します。',without:'契約やCLIだけあっても、実際に処理する部品は存在しません。',confuse:'Cloud CLIをPCへ入れることと、ResourceをCloud上に作ることは別です。',category:'cloud'},
  ...
  {id:'console',label:'Console',aliases:['Console','コンソール'],plain:'Providerの操作画面',summary:'BrowserからResourceを作成・確認・削除できる画面です。',where:'Console・CLI・IaCは、どれも同じAPIを呼ぶ操作手段です。',without:'画面からResourceを操作できません。',confuse:'Consoleで作ったResourceも、本体はProvider側にあります。',category:'cloud'},
