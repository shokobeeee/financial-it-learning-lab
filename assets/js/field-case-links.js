...
function loadComponentRationale(){
  if(!document.querySelector('link[data-component-rationale]')){
    const l=document.createElement('link');l.rel='stylesheet';l.href='../assets/css/component-rationale.css?v=1';l.dataset.componentRationale='1';document.head.appendChild(l);
  }
  if(document.querySelector('script[data-component-rationale]'))return;
  const s=document.createElement('script');s.src='../assets/js/component-rationale.js?v=1';s.dataset.componentRationale='1';document.body.appendChild(s);
}
function loadCss(){
...
function ensureData(){
  loadNavigationScroll();loadComponentRationale();loadCss();
